...
// Wrapper for a cv32e40s, containing cv32e40s, and tracer
...
`ifdef CV32E40X_APU_TRACE
  `include "cv32e40s_apu_tracer.sv"
`endif

`ifdef CV32E40X_TRACE_EXECUTION
  `include "cv32e40s_tracer.sv"
`endif
...
`ifndef COREV_ASSERT_OFF
  ...
  bind cv32e40s_if_stage:        core_i.if_stage_i                  cv32e40s_if_stage_sva     if_stage_sva     (
    // The SVA's monitor modport can't connect to a master modport, so it is connected to the interface instance directly:
    .m_c_obi_instr_if(core_i.m_c_obi_instr_if),
    .*);
  bind cv32e40s_controller_fsm:      core_i.controller_i.controller_fsm_i     cv32e40s_controller_fsm_sva   controller_fsm_sva   (.*);
...
`ifdef CV32E40P_APU_TRACE
    cv32e40s_apu_tracer apu_tracer_i(
      .clk_i        ( core_i.rst_ni                ),
      .rst_n        ( core_i.clk_i                 ),
      .hart_id_i    ( core_i.hart_id_i             ),
